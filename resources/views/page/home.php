				...
				<div class="container box">
					...
					<div class="tile is-ancestor">
						...
						<div class="tile is-parent is-8">
							<div class="tile is-child is-clipped">
								...
								<article class="media">
									...
									<div class="media-content">
										<div class="content">
											...
											<p>
												Сервер
												<strong>FURS.Chat</strong> живёт бурной жизнью. У нас можно обсудить новости из мира науки, ИТ, индустрии игр, фильмов, книг и многое другое...
											</p>
										</div>
									</div>
								</article>
								...
								<article class="media">
									...
									<div class="media-content">
										<div class="content">
											...
											<p>
												<strong>Ролевые игры</strong> - неотъемлемая часть любого сервера. Только у нас имеется ролевая игра под названием
												<strong>Serenity</strong>, которая позволяет полностью погрузиться в мир космических путешествий.
											</p>
										</div>
									</div>
								</article>
								...
								<article class="media">
									...
									<div class="media-content">
										<div class="content">
											...
											<p>
												На нашем канале
												<a href="https://furs.stream/"><strong>FURS.Stream</strong></a> проводится потоковое вещание
									...
									<div class="media-content">
										<div class="content">
											...
											<p>
												...
												<a href="https://library.furs.wiki/"><strong>FURS / LIBRARY</strong></a>, а также остальными ресурсами сети
												<strong>FURS</strong>. Все изменения автоматически публикуются в специальном канале
												<strong>FURS.Chat</strong>'а, поэтому Вы не пропустите ни одного события.
											</p>
										</div>
									</div>
								</article>
								...
								<article class="media">
									...
									<div class="media-content">
										<div class="content">
											...
											<p>
												Сервер
												<strong>FURS.Chat</strong> постоянно обновляется и внедряет новые возможности. Мы первыми реализовали категории для каналов и первыми интегрировали потоки радио-вещания с серверов Discord на внешние источники.
											</p>
										</div>
									</div>
								</article>
						...
						<div class="tile is-parent">
							<div class="tile is-child">
								<article class="content">
									...
									<ul>
										<li>
											Более <span class="tag is-info">10</span> тематических каналов для общения.
										</li>
										<li>
											Более <span class="tag is-info">3</span> каналов для RP-тематики.
										</li>
										<li>
											Более
											<span class="tag is-info">6</span> каналов для общения при помощи голосовой связи.
										</li>
									</ul>
								</article>
							</div>
